 ...
 * @property {'anchor' | 'slot' | 'collection' | 'key'} kind Session storage containing the root.
 * @property {number | string} index Index within that storage.
 ...
 *   | { kind: 'Async', keys: never[], children: Child[], data: { source: JavaScriptSource, pending: number, captured: boolean, state: Source, key: string | undefined } }
